                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/login') }}">
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            <label for="email" class="col-md-4 control-label">Access key ID</label>
                        ...
                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                            <label for="password" class="col-md-4 control-label">Secret access key</label>
                        ...
                        <div class="form-group{{ $errors->has('endpoint') ? ' has-error' : '' }}">
                            <label for="endpoint" class="col-md-4 control-label">Endpoint URL</label>
